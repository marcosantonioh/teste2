...
class ExercicioAdmin(ImportExportModelAdmin):
    ...
    fieldsets = (
        ...
        ('Campos para Informativo', {
            'classes': ('exercicio-tipo', 'exercicio-info'), # Mostra para o tipo 'info'
            'fields': ('imagem',),
        }),
        ('Campos para Verdadeiro ou Falso', {
            'classes': ('exercicio-tipo', 'exercicio-vf'), # Mostra para o tipo 'vf'
    ...
    def get_changeform_initial_data(self, request):
        ...
        if estacao_id:
            try:
                ...
                estacao_obj = Estacao.objects.select_related('secao__modulo').get(pk=estacao_id)
