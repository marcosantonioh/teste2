...
MIDDLEWARE = [
    ...
    'core.middleware.NaoArmazenarPaginasAutenticadasMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.usuarios.context_processors.notificacoes_amizade',
            ],
        },
    },
]
...
# O caminho absoluto para a pasta onde o `collectstatic` vai juntar os arquivos
